...
(59, 31, 21),  -- "海の幸 魚福" → 海鮮料理
(60, 32, 2),   -- "ラーメン道場 風神" → ラーメン
(61, 33, 4),   -- "うどん工房 さくら" → うどん
(62, 34, 13),  -- "焼肉やすらぎ" → 焼肉
(63, 35, 6),   -- "スイーツ工房 フルール" → スイーツ
(64, 36, 3),   -- "味の匠 まるしん" → 和食
(65, 37, 7),   -- "フレンチダイニング ラルゴ" → フランス料理
(66, 38, 7),   -- "ビストロ 風雅" → フランス料理
(67, 39, 20),  -- "ピッツェリア・マリーナ" → イタリア料理
(68, 40, 1);   -- "鶴見屋 鮨処" → 寿司
